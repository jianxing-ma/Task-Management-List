...
namespace Task_Tracking_Application
{
    ...
    class TaskTrackingApp
    {
        ...
        // use console readkey to exit save or open file
        // why default save for SaveFile



        //public static void DeleteItem(List<string> List, int i)
        //{
        //    TBF
        //}
        ...
        //public static void MainMenu(List<string> Tasks)
        //{
        //    //Console.WriteLine("Task Management\n");
        //    Console.WriteLine("Write Task: w | Up: u | Down: dn | Delete: d | Re-enter: re | Quit: q");
        ...
        //public static void MoveCursor(List<string> List, int i = 0)
        //{ 
        //    i++;
        //    Console.Clear();
        //    DisplayTasks(List, i);
